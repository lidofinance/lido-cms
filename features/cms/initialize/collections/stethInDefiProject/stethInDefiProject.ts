...
export const stethInDefiProject: CmsCollection = {
  ...
  fields: [
    ...
    },
    {
      ...
      search_fields: ["curators.*.label"],
      value_field: "curators.*.id",
      display_fields: ["curators.*.label"],
    } as unknown as CmsField,
    { label: "Protocol", name: "protocol", widget: "string", required: false },
    {
      ...
      collection: "steth-in-defi-config",
      file: "project-steth-in-defi-config",
      search_fields: ["depositableTokens.*.label"],
      value_field: "depositableTokens.*.id",
      display_fields: ["depositableTokens.*.label"],
    } as unknown as CmsField,
    {
      label: "Network",
      name: "networkId",
    ...
    { label: "TVL Key", name: "tvlId", widget: "string", required: false },
    {
      ...
      collection: "steth-in-defi-config",
      file: "project-steth-in-defi-config",
      search_fields: ["additionalRewards.*.label"],
      value_field: "additionalRewards.*.id",
      display_fields: ["additionalRewards.*.label"],
      multiple: true,
    } as unknown as CmsField,
    {
